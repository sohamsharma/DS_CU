						    ...
						    for(p = 0; p < noOfRecords; ++p)
								{
								   for ( i = 0 ; i < ( noOfRecords - 1 ) ; i++ )
								   {
								      ...
								      for ( j = i + 1 ; j < noOfRecords ; j++ )
								      {
								         if ( (ptr+position)->subject[0] >(ptr+j)->subject[0] )
								            position = j;
								      }
								      if ( position != i )
								      {
...
/*						if (noOfRecords!=0)
						{
						  ...
						  for (i = 1 ; i <= noOfRecords - 1; i++) {
						    j = i;
						    while ( j > 0 && (ptr+j)->rollno < (ptr+j-1)->rollno) {
								         temp = (ptr+i)->rollno;
								         strcpy(temp2,(ptr+i)->subject);
								         temp3= (ptr+i)->marks;
								         (ptr+i)->rollno = (ptr+position)->rollno;
						   ...
						   for(p = 0; p < noOfRecords ; ++p)
							...
							for (i = 1 ; i <= noOfRecords - 1; i++) {
						    j = i;
						    while ( j > 0 && (ptr+j)->subject[0] < (ptr+j-1)->subject[0]) {
								         temp = (ptr+i)->rollno;
								         strcpy(temp2,(ptr+i)->subject);
								         temp3= (ptr+i)->marks;
								         (ptr+i)->rollno = (ptr+position)->rollno;
						   ...
						   for(p = 0; p < noOfRecords ; ++p)
						    ...
						    for (i = 1 ; i <= noOfRecords - 1; i++) {
						    j = i;
						    while ( j > 0 && (ptr+j)->marks < (ptr+j-1)->marks) {
								         temp = (ptr+i)->rollno;
								         strcpy(temp2,(ptr+i)->subject);
								         temp3= (ptr+i)->marks;
								         (ptr+i)->rollno = (ptr+position)->rollno;
